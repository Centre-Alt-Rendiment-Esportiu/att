  ...
  while not done:
    ...
    if state == COLLECT:
      if is_right_side:
          ...
          side_msg = "Left side, "
      curMsg = side_msg + "drop the ball at the spot, %i/5" % (repetition)

      pygame.draw.circle(screen, (200, 0, 0), (positions[curSpot][1] * SCREEN_MULITPLIER, positions[curSpot][0] * SCREEN_MULITPLIER), 0.5 * SCREEN_MULITPLIER)
    ...
    if state == PROMPT:
      ...
      if pressed[pygame.K_RETURN] and isButtonUp:
