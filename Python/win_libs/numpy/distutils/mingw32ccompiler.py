...
class Mingw32CCompiler(distutils.cygwinccompiler.CygwinCCompiler):
    ...
    def __init__ (self,
        ...
        # CG: disable building msvc runtime library as they are typically included with mingw
        msvcr_success = False  # build_msvcr_library()
        msvcr_dbg_success = False  # build_msvcr_library(debug=True)
        ...
        if get_build_architecture() == 'AMD64':
            if self.gcc_version < "4.0":
                ...
                self.set_executables(
                    compiler='gcc -m64 -g -DNDEBUG -DMS_WIN64 -O2 -Wall',
                    compiler_so='gcc -m64 -g -DNDEBUG -DMS_WIN64 -O2 -Wall -Wstrict-prototypes',
                    linker_exe='gcc -m64 -g',
                    linker_so='gcc -m64 -g -shared')
        else:
